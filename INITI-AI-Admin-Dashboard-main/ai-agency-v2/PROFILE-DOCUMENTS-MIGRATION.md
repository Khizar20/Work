# Database Migration Script for Profiles and Documents

This document explains the SQL migrations needed to support the profile management and document upload features.
...
ALTER TABLE documents ADD COLUMN IF NOT EXISTS vector_id TEXT;
